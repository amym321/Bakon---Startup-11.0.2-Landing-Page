...
;// CONCATENATED MODULE: ./node_modules/@pixelunion/pxs-map/src/scripts/utils.js
/*
...
function createMap(options) {
  ...
  return getLatitudeLongitude(address)
    .then((latLong) => {
...
;// CONCATENATED MODULE: ./node_modules/@pixelunion/pxs-map/src/scripts/index.js
  ...
  constructor(section) {
    ...
    if (apiKey) {
      if (window.googleMaps === undefined) {
        script_default()(`https://maps.googleapis.com/maps/api/js?key=${apiKey}`, () => {
...
/* harmony default export */ const pxs_slideshow_dist_index_es = (Slideshow);
...
var index_es_script = index_es_createCommonjsModule(function (module) {
/*!
  * $script.js JS loader & dependency manager
  * https://github.com/ded/script.js
  * (c) Dustin Diaz 2014 | License MIT
...
var VimeoPlayer = /*#__PURE__*/function () {
  ...
  index_es_createClass(VimeoPlayer, [{
    key: "play",
    value: function play() {
      var _this2 = this;
...
var HTML5Video = /*#__PURE__*/function () {
  ...
  index_es_createClass(HTML5Video, [{
    key: "setupVideo",
...
;// CONCATENATED MODULE: ./node_modules/@pixelunion/pxs-testimonials/dist/index.es.js
...
var index_es_commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof __webpack_require__.g !== 'undefined' ? __webpack_require__.g : typeof self !== 'undefined' ? self : {};
...
var index_es_evEmitter = dist_index_es_createCommonjsModule(function (module) {
/**
 * EvEmitter v1.1.0
 * Lil' event emitter
 * MIT License
...
}( typeof window != 'undefined' ? window : index_es_commonjsGlobal, function() {
...
var index_es_getSize = dist_index_es_createCommonjsModule(function (module) {
/*!
 * getSize v2.0.3
 * measure size of elements
 * MIT license
...
var index_es_matchesSelector = dist_index_es_createCommonjsModule(function (module) {
/**
 * matchesSelector v2.0.2
 * matchesSelector( element, '.selector' )
 * MIT license
...
var index_es_utils = dist_index_es_createCommonjsModule(function (module) {
/**
 * Fizzy UI utils v2.0.7
 * MIT license
 */
...
var index_es_cell = dist_index_es_createCommonjsModule(function (module) {
// Flickity.Cell
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_slide = dist_index_es_createCommonjsModule(function (module) {
// slide
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_animate = dist_index_es_createCommonjsModule(function (module) {
// animate
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_flickity = dist_index_es_createCommonjsModule(function (module) {
// Flickity main
...
var index_es_unipointer = dist_index_es_createCommonjsModule(function (module) {
/*!
 * Unipointer v2.3.0
 * base class for doing one thing with pointer event
 * MIT license
...
var index_es_unidragger = dist_index_es_createCommonjsModule(function (module) {
/*!
 * Unidragger v2.3.1
 * Draggable base class
 * MIT license
...
var index_es_drag = dist_index_es_createCommonjsModule(function (module) {
// drag
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_prevNextButton = dist_index_es_createCommonjsModule(function (module) {
// prev/next buttons
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_pageDots = dist_index_es_createCommonjsModule(function (module) {
// page dots
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_player = dist_index_es_createCommonjsModule(function (module) {
// player & autoPlay
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_addRemoveCell = dist_index_es_createCommonjsModule(function (module) {
// add, remove cell
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_lazyload = dist_index_es_createCommonjsModule(function (module) {
// lazyload
( function( window, factory ) {
  // universal module definition
  if (  module.exports ) {
...
var index_es_js = dist_index_es_createCommonjsModule(function (module) {
/*!
 * Flickity v2.2.2
 * Touch, responsive, flickable carousels
 *
...
( function( window, factory ) {
  ...
  if (  module.exports ) {
    ...
    module.exports = factory(
        index_es_flickity,
        index_es_drag,
        index_es_prevNextButton,
        index_es_pageDots,
        index_es_player,
        index_es_addRemoveCell,
        index_es_lazyload
    );
  }
...
var index_es_flickityFade = dist_index_es_createCommonjsModule(function (module) {
/**
 * Flickity fade v1.0.0
 * Fade between Flickity slides
 */
...
}( index_es_commonjsGlobal, function factory( Flickity, utils ) {
...
var index_es_EventHandler = index_es_unwrapExports(index_es_EventHandler_1);

var Testimonials = /*#__PURE__*/function () {
  function Testimonials(section) {
    dist_index_es_classCallCheck(this, Testimonials);

    this.el = section.el;
    this.settings = section.data;
    this.slider = this.el.querySelector('[data-testimonials-content]');
    this.slides = this.el.querySelectorAll('[data-testimonial]');
    this.flickity = false;
    this.events = new index_es_EventHandler();

    if (this.settings.init_slider === true && this.slides.length > 1) {
      this.initFlickity();
    }
  }

  dist_index_es_createClass(Testimonials, [{
    key: "initFlickity",
    value: function initFlickity() {
      var _this = this;

      this.flickity = new index_es_flickityFade(this.slider, {
        adaptiveHeight: true,
        autoPlay: this.settings.enable_autoplay ? this.settings.autoplay_interval * 1000 : false,
        groupCells: this.settings.group_testimonials,
        fade: this.settings.use_fade,
        cellAlign: 'left',
        cellSelector: '[data-testimonial]',
        contain: true,
        imagesLoaded: true,
        pageDots: this.settings.show_pagination,
        pauseAutoPlayOnHover: true,
      ...
      this.events.register(this.slider, 'rimg:load', function () {
        _this.flickity.resize();
      });
    }
  }, {
    ...
    value: function onSectionBlockSelect(block) {
      if (this.flickity) {
        var index = block.el.dataset.index;
...
/* harmony default export */ const pxs_testimonials_dist_index_es = (Testimonials);
...
var dist_EventHandler = __webpack_require__(766);
...
/* harmony default export */ const components_Modal = (new Modal());
...
class ProductGallery {
  ...
  _onExternalVideoLibraryLoad() {
    ...
    videoFigures.forEach(videoFigure => {
      const player = new YT.Player(videoFigure.querySelector('iframe'));
      const video = {
        type: 'video',
        figure: videoFigure,
        player,
  ...
  _onMediaSelect(media) {
    ...
    switch (media.type) {
      case 'video':
        ...
        if (this.settings.enable_video_autoplay && cjs/* min */.VV('L') && this.layout !== 'list') {
          media.play();
        }
...
class ThemeUtils {
  ...
  static windowWidth() {
    ...
    const width = documentWidth < windowWidth ? windowWidth : documentWidth;
    return width;
  }
  ...
  static externalLinks($el) {
    const anchors = $el.find('a[href^="http"]').filter((i, el) => el.href.indexOf(window.location.hostname) === -1);
...
class LinkedOptions {
  ...
  _updateOptions(optionIndex, optionsMap) {
    let $option;
    let $selector;
    const nextSelector = optionIndex + 1;
    let updateSelected = false;

    const {
      key,
      selector
    } = this._getCurrent(optionIndex);

    const availableOptions = optionsMap[key] || [];

    if (this.options.type === 'select') {
      $selector = this.options.$productForm.find(selector);
      const initialValue = $selector.val();
      const $selectorOptions = $selector.find('option');
      $selectorOptions.each((index, option) => {
    ...
    const $nextOption = this.options.$selector.filter(`[data-option-index=${nextSelector}]`);
  ...
  _mapVariants(product) {
    ...
    product.variants.forEach(variant => {
      if (variant.available) {
        ...
        optionsMap.root = ThemeUtils.unique(optionsMap.root); // Gather values for the 2nd option type

        if (product.options.length > 1) {
          key = variant.option1;
          optionsMap[key] = optionsMap[key] || [];
          optionsMap[key].push(variant.option2);
          optionsMap[key] = ThemeUtils.unique(optionsMap[key]);
    ...
    this.options.$selector.on('change', event => {
      const index = parseInt(jquery_default()(event.currentTarget).attr('data-option-index'), 10);
      const nextSelector = index + 1;
...
class VariantHelper {
  constructor(options) {
    const defaultOptions = {
      ...
      onVariantChange: () => {},
      // Callback to run on variant change
      quantityInput: null // Quantity input element

    };
    this.options = ThemeUtils.extend(defaultOptions, options);
    this.$body = jquery_default()(document.body);
    this.linkedOptions = null;
    this.enableHistory = false;
    this.$masterSelect = this.options.$productForm.find(`#product-select-${this.options.formID}`); // Disabled history state updating in the TE
  ...
  _init() {
    if (this.options.type === 'select') {
      for (let i = 0; i < this.options.$selector.length; i++) {
        const select = this.options.$selector[i];
  ...
  _bindEvents() {
    return this.options.$selector.on('change', event => this._variantChange(event));
  }
  ...
  _setSelectLabel() {
    ...
    const selectedOption = $element.find('option:selected').val();
  ...
  _getCurrentOptions() {
    ...
    $inputs.each((index, element) => productOptions.push(jquery_default()(element).val()));
    return productOptions;
  }

  _getVariantFromOptions(productOptions) {
    if (this.options.productJSON.variants == null) {
      return;
    }

    let foundVariant = null;
    this.options.productJSON.variants.forEach(variant => {
      let productOption = productOptions[0];
  ...
  _updateMasterSelect(variant) {
    ...
    this.$masterSelect.find(`[data-variant-id=${variant.id}]`).prop('selected', true);
  ...
  _updatePrice(variant) {
    ...
    if (variant != null) {
      ...
      const unitPrice = $priceFields.find('[data-unit-price]')[0];

      if (unitPrice && variant.unit_price_measurement) {
        const totalQuantity = unitPrice.querySelector('[data-total-quantity]');
        const unitPriceAmount = unitPrice.querySelector('[data-unit-price-amount]');
        const unitPriceMeasure = unitPrice.querySelector('[data-unit-price-measure]');
  ...
  _updateTaxLine(variant) {
    ...
    if (this.options.$priceFields.length > 0) {
      taxLine = this.options.$priceFields[0].querySelector('[data-tax-line]');
    }

    if (!taxLine) return;

    if (variant.taxable) {
      taxLine.classList.remove('product-price__tax-label--hidden');
    } else {
      taxLine.classList.add('product-price__tax-label--hidden');
    }
  }
  ...
  _updateImages(variant) {
    ...
    this.options.$productThumbnails.filter(`[data-media='${imageId}']`).trigger('click');
  }
  ...
  _updateHistory(variant) {
    ...
    if (window.location.search.length > 0) {
      if (window.location.search.match(variantRegex)) {
        search = window.location.search.replace(variantRegex, `variant=${variant.id}`);
      } else {
        search = `${window.location.search}&variant=${variant.id}`;
      }
    }
  ...
  _variantChange(event) {
    ...
    const productOptions = this._getCurrentOptions();

    const variant = this._getVariantFromOptions(productOptions);
...
class Product {
  constructor(section) {
    ...
    const gallery = this.el.querySelector('[data-product-gallery]');

    if (gallery) {
      this.productGallery = new ProductGallery(gallery, {
    ...
    const $productJSON = jquery_default()(`[data-product-json-${this.formID}]`, this.$el);
    const $productSettings = jquery_default()(`[data-product-settings-${this.formID}]`, this.$el);
    ...
    this.$variantDropdowns = jquery_default()(`[data-option-select=${this.formID}]`, this.$el);
    this.$variantRadio = jquery_default()(`[data-option-input=${this.formID}]`, this.$el);
  ...
  setupVariants() {
    ...
    const variantHelperDefaults = {
      ...
      onVariantChange: variant => this._onVariantChangeCallback(variant),
    ...
    if (this.$variantDropdowns.length) {
      ...
      dropdownSettings = ThemeUtils.extend(variantHelperDefaults, dropdownSettings);
    ...
    if (this.$variantRadio.length) {
      ...
      radioSettings = ThemeUtils.extend(variantHelperDefaults, radioSettings);
      this.variantHelpers = new VariantHelper(radioSettings);
      this.$variantRadio.trigger('change');
    }

    const selectedVariant = () => this.variantHelpers ? this.variantHelpers.getSelectedVariant() : this.productJSON.variants[0]; // product has only default variant


    this.surfacePickUp.load(selectedVariant().id);
    this.surfacePickUp.onModalRequest(content => {
      const variantTitle = this.variantHelpers ? `<div class="modal__surface-pick-up-variant">${selectedVariant().title}</div>` : '';
      const header = `
  ...
  _onVariantChangeCallback(variant) {
    if (variant) {
      this.surfacePickUp.load(variant.id);
      this.paymentTerms.update(variant.id);
    } else {
      this.el.querySelector('[data-surface-pick-up]').innerHTML = '';
    }
  }
  ...
  addToCart(e) {
    ...
    const quantity = jquery_default()('input[name="quantity"]', this.$el).val();

    if (quantity === '' || quantity === '0') {
      setTimeout(() => {
        jquery_default()('input[name="quantity"]', this.$el).addClass('error');
        this.$productMessage.removeClass('success').addClass('error').text(this.productSettings.setQuantityText);
        jquery_default()('.add-to-cart', this.$el).removeClass('loading');
        this.processing = false;
      }, 500);
    }

    Shopify.addItemFromForm(this.productForm, cartItem => setTimeout(() => {
      ...
      const successMessage = this.productSettings.successMessage.replace('** product **', cartItem.title);
      jquery_default()('input[name="quantity"]', this.$el).removeClass('error');
      jquery_default()('.add-to-cart', this.$el).removeClass('loading');
      this.$productMessage.removeClass('error').addClass('success').html(successMessage);

      if (!Modernizr.cssanimations) {
        this.$addToCartButton.val(this.productSettings.addToCartText);
      }
  ...
  handleErrors(errors) {
    const errorMessage = jquery_default().parseJSON(errors.responseText);
    const productTitle = this.productJSON.title;
    let errorDescription = errorMessage.description;
    ...
    if (errorMessage.message === 'Cart Error') {
      setTimeout(() => {
        jquery_default()('input[name="quantity"]', this.$el).removeClass('error');
        this.$productMessage.removeClass('success').addClass('error').html(errorDescription);
        jquery_default()('.add-to-cart', this.$el).removeClass('loading added-success').addClass('added-error');
...
;// CONCATENATED MODULE: ./node_modules/@pixelunion/pxs-faq/dist/index.es.js
...
function pxs_faq_dist_index_es_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

function pxs_faq_dist_index_es_defineProperties(target, props) {
  for (var i = 0; i < props.length; i++) {
    var descriptor = props[i];
    descriptor.enumerable = descriptor.enumerable || false;
    descriptor.configurable = true;
...
function pxs_faq_dist_index_es_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) pxs_faq_dist_index_es_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) pxs_faq_dist_index_es_defineProperties(Constructor, staticProps);
  return Constructor;
}
...
function pxs_faq_dist_index_es_createCommonjsModule(fn, module) {
	return module = { exports: {} }, fn(module, module.exports), module.exports;
}

var dist_index_es_EventHandler_1 = pxs_faq_dist_index_es_createCommonjsModule(function (module, exports) {
exports.__esModule = true;
var EventHandler = /** @class */ (function () {
    function EventHandler() {
        this.events = [];
...
var dist_index_es_EventHandler = dist_index_es_unwrapExports(dist_index_es_EventHandler_1);
...
var FAQ = /*#__PURE__*/function () {
  function FAQ(section) {
    ...
    pxs_faq_dist_index_es_classCallCheck(this, FAQ);
    ...
    this.openState = 'open';
    this.initAnimations();
    this.summaryEls.forEach(function (summary) {
      _this.events.register(summary, 'click', function (event) {
        return _this.animateAccordion(event);
      });
    });
  }

  pxs_faq_dist_index_es_createClass(FAQ, [{
    key: "initAnimations",
    value: function initAnimations() {
      var _this2 = this;

      this.summaryEls.forEach(function (summary) {
        var currentAnswerEl = summary.nextElementSibling;
        var currentDetailsEl = summary.closest('[data-faq-details]');
        var index = currentAnswerEl.dataset.faqAnswerIndex;
        _this2.animations[index] = index_es_transition({
          el: currentAnswerEl,
          state: _this2.closedState
        });
        currentDetailsEl.style.setProperty('--closed-height', "".concat(summary.offsetHeight, "px"));
      });
    }
  }, {
    key: "animateAccordion",
    value: function animateAccordion(event) {
      event.preventDefault();
      var summary = event.currentTarget;
      var currentAnswerEl = summary.nextElementSibling;
      var currentDetailsEl = summary.closest('[data-faq-details]');
      if (currentAnswerEl.dataset.animation) return;
    ...
    key: "openAccordion",
    value: function openAccordion(detailsEl) {
      var answerEl = detailsEl.querySelector('[data-faq-answer]');
      var answerIndex = answerEl.dataset.faqAnswerIndex;
      detailsEl.setAttribute('open', '');
      this.animations[answerIndex].animateTo(this.openState, {
        onStart: function onStart(_ref) {
          var el = _ref.el;
          el.style.setProperty('--open-height', "".concat(el.offsetHeight, "px"));
        }
      });
    }
  }, {
    key: "closeAccordion",
    value: function closeAccordion(detailsEl) {
      var answerIndex = detailsEl.querySelector('[data-faq-answer]').dataset.faqAnswerIndex;
      this.animations[answerIndex].animateTo(this.closedState).then(function () {
...
/* harmony default export */ const pxs_faq_dist_index_es = (FAQ);

;// CONCATENATED MODULE: ./source/scripts/sections/DynamicFAQ.js


class DynamicFAQ extends pxs_faq_dist_index_es {
  constructor(section) {
    super(section);
    this.el = section.el;
    this.allAnswerElements = this.el.querySelectorAll('[data-faq-answer]');
    this._onBreakpointChange = this._onBreakpointChange.bind(this);
    cjs/* onChange */.z2(this._onBreakpointChange);
  }

  _resizeAnswerElements() {
    this.allAnswerElements.forEach(answersEl => {
      if (answersEl.dataset.animationState === 'open') {
        answersEl.style.setProperty('--open-height', 'auto');
      }
    });
  }

  _onBreakpointChange() {
    this._resizeAnswerElements();
  }
...
class DynamicTwitter {
  ...
  _validate() {
    ...
    const username = jquery_default()('[data-twitter-username]', this.$el).attr('data-twitter-username');
    const retweets = jquery_default()('[data-show-retweets]', this.$el).length;
    const showImages = jquery_default()('[data-show-images]', this.$el).length;
  ...
  _fetchTweets(username, retweets, showImages) {
    const config = {
      profile: {
        screenName: username
      },
  ...
  renderTweets(tweets) {
    if (tweets.length) {
      const $tweet = jquery_default()(tweets[0]);
      const media = jquery_default()($tweet[3]);
...
;// CONCATENATED MODULE: ./node_modules/@pixelunion/pxs-header-standard/dist/index.es.js
...
function pxs_header_standard_dist_index_es_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

function pxs_header_standard_dist_index_es_defineProperties(target, props) {
  for (var i = 0; i < props.length; i++) {
    var descriptor = props[i];
    descriptor.enumerable = descriptor.enumerable || false;
    descriptor.configurable = true;
...
function pxs_header_standard_dist_index_es_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) pxs_header_standard_dist_index_es_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) pxs_header_standard_dist_index_es_defineProperties(Constructor, staticProps);
  return Constructor;
}

function pxs_header_standard_dist_index_es_unwrapExports (x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}

function pxs_header_standard_dist_index_es_createCommonjsModule(fn, module) {
	return module = { exports: {} }, fn(module, module.exports), module.exports;
}

var pxs_header_standard_dist_index_es_EventHandler_1 = pxs_header_standard_dist_index_es_createCommonjsModule(function (module, exports) {
exports.__esModule = true;
var EventHandler = /** @class */ (function () {
    function EventHandler() {
        this.events = [];
...
var pxs_header_standard_dist_index_es_EventHandler = pxs_header_standard_dist_index_es_unwrapExports(pxs_header_standard_dist_index_es_EventHandler_1);
...
function index_es_classCallCheck$1(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}
...
function index_es_createClass$1(Constructor, protoProps, staticProps) {
  if (protoProps) index_es_defineProperties$1(Constructor.prototype, protoProps);
  if (staticProps) index_es_defineProperties$1(Constructor, staticProps);
  return Constructor;
}
...
function () {
   ...
   */
  function Animation(options) {
    index_es_classCallCheck$1(this, Animation);
  ...
  index_es_createClass$1(Animation, [{
    key: "isState",
    ...
    value: function animateTo(state) {
      ...
      return new Promise(function (resolve) {
        ...
        dist_index_es_raf().then(function () {
          if (!running) throw new Error('cancelled');
...
function dist_index_es_transition(options) {
  return new dist_index_es_Animation(options);
}

var HeaderNavParent = /*#__PURE__*/function () {
  function HeaderNavParent(options) {
    var _this = this;

    pxs_header_standard_dist_index_es_classCallCheck(this, HeaderNavParent);

    this.menuItem = options.menuItem;
    this.detailsItem = options.menuItem.querySelector('[data-header-nav-details]');
    this.parentMenu = options.parentMenu;
    this.menuLink = this.detailsItem.querySelector('[data-header-nav-link]');
    this.submenuEl = this.menuItem.querySelector('[data-header-nav-submenu]');
    this._isOpen = false;
    this.submenu = null;
    this.events = new pxs_header_standard_dist_index_es_EventHandler();
    this._open = this._open.bind(this);
    this._close = this._close.bind(this);
    this.close = this.close.bind(this); // When a user hits the escape key all of the menus should close and the keyboard focus should return
    // to the parent link. This will bubble up to the top parent menu.

    this.closeEsc = function (e) {
      if (e.key === 'Escape') {
        _this.menuLink.focus();
    ...
    this.click = function (e) {
      e.stopPropagation(); // If the menu is already open, we want to continue to the link in the <a> tag.
      ...
      var clickedParent = e.target.closest('[data-header-nav-link]');
    ...
    this.focusin = function (e) {
      ...
      _this.parentMenu.closeSiblings(_this);
    }; // Set up animation event


    this.animation = dist_index_es_transition({
      el: this.submenuEl,
      state: 'closed'
    });
    this.events.register(this.menuItem, 'mouseover', function () {
      return _this.mouseover();
    });
    this.events.register(this.menuItem, 'mouseout', function () {
      return _this.mouseout();
    });
    this.events.register(this.menuItem, 'click', function (e) {
      return _this.click(e);
    });
    this.events.register(this.menuItem, 'touchend', function (e) {
      return _this.click(e);
    });
    this.events.register(this.menuItem, 'focusin', function (e) {
  ...
  pxs_header_standard_dist_index_es_createClass(HeaderNavParent, [{
    key: "forceOpen",
    ...
    value: function _open() {
      ...
      if (!this.submenu) {
        this.submenu = new HeaderNavMenu({
          navList: this.submenuEl
        });
      }
      ...
      this.animation.animateTo('open', {
        onStart: function onStart(_ref) {
          ...
          var menuBounds = el.getBoundingClientRect();

          if (menuBounds.right > document.documentElement.clientWidth) {
            el.classList.add('alternate-drop');
          }

          if (menuBounds.left < 0) {
            el.classList.add('alternate-drop-left');
          }
        }
      });
    ...
    value: function _close() {
      ...
      this.animation.animateTo('closed').then(function () {
        _this3.submenuEl.classList.remove('alternate-drop');

        _this3.menuLink.setAttribute('aria-expanded', false);

        _this3.detailsItem.removeAttribute('open');
      });
    }
  }, {
    key: "unload",
  ...
  return HeaderNavParent;
}();

var HeaderNavMenu = /*#__PURE__*/function () {
  function HeaderNavMenu(options) {
    var _this = this;

    pxs_header_standard_dist_index_es_classCallCheck(this, HeaderNavMenu);
    ...
    for (var i = 0; i < this.menuItems.length; i++) {
      ...
      if (menuItem.dataset.headerNavParent !== undefined) {
        this.parents.push(new HeaderNavParent({
          menuItem: menuItem,
          parentMenu: this
        }));
      } else {
        ...
        this.events.register(menuItem, 'focusin', function () {
          return _this.closeAllMenus();
        });
      }
    }
  ...
  pxs_header_standard_dist_index_es_createClass(HeaderNavMenu, [{
    key: "closeSiblings",
    value: function closeSiblings(current) {
...
// It is a separate class so that we can initialize it on its own with different headers.

var HeaderNav = /*#__PURE__*/function () {
  function HeaderNav(options) {
    pxs_header_standard_dist_index_es_classCallCheck(this, HeaderNav);

    this.header = options.header;
    this.navTier1 = this.header.querySelector('[data-header-nav-tier-1]');

    if (this.navTier1) {
      this.headerNavMenu = new HeaderNavMenu({
        navList: this.navTier1
      });
    }
  }

  pxs_header_standard_dist_index_es_createClass(HeaderNav, [{
    key: "unload",
    value: function unload() {
      if (this.headerNavMenu) {
...
var HeaderStandard = /*#__PURE__*/function () {
  function HeaderStandard(section) {
    var _this = this;

    pxs_header_standard_dist_index_es_classCallCheck(this, HeaderStandard);

    this.el = section.el;
    this.data = section.data;
    this.sticky = this.data.sticky;
    this.transparent = this.data.transparent;
    this.events = new pxs_header_standard_dist_index_es_EventHandler();
    this.header = this.el.querySelector('[data-site-header]');
    this.headerLogo = this.el.querySelector('[data-header-logo]');
    this.logoImage = this.el.querySelector('[data-logo-image]');
    this.logoImageTransparent = this.el.querySelector('[data-logo-image-transparent]');
    this.logoImageMobile = this.el.querySelector('[data-logo-image-mobile]');
    this.cartCount = this.el.querySelector('[data-cart-count]');
    this.scrollObserver = null;
    this.scrollObserverPoint = this.el.querySelector('[data-header-scroll-observer]'); // We need to place the scroll observer point to be outside of the header within the body tag.

    document.body.appendChild(this.scrollObserverPoint);
    this._setTransparency = this._setTransparency.bind(this);
    this.events.register(window, 'resize', function () {
      return _this._recordSizeVariables();
    });
    this.events.register(this.header, 'rimg:load', function () {
      return _this._recordSizeVariables();
    });
    this.events.register(document, 'cart:count', function (e) {
      return _this._updateCartCount(e);
    }); // In the editor, listen for events when another section is moved (in case it is first)

    this.events.register(window, 'shopify:section:reorder', function () {
      return _this._initTransparency();
    });

    this._initTransparency();

    this._recordSizeVariables();
  ...
  pxs_header_standard_dist_index_es_createClass(HeaderStandard, [{
    key: "_recordSizeVariables",
    value: function _recordSizeVariables() {
      this._recordHeaderHeight();

      this._recordLogoWidth();
    }
  }, {
    key: "_recordHeaderHeight",
    value: function _recordHeaderHeight() {
      document.body.style.setProperty('--header-height', "".concat(this.header.offsetHeight, "px"));
    }
  }, {
    key: "_recordLogoWidth",
    value: function _recordLogoWidth() {
      // If the image exists and is visible, record its width in a CSS variable.
      if (this.logoImage && this.logoImage.offsetParent) {
        this.header.style.setProperty('--logo-width', "".concat(this.logoImage.getBoundingClientRect().width, "px"));
      } else if (this.logoImageTransparent && this.logoImageTransparent.offsetParent) {
        this.header.style.setProperty('--logo-width', "".concat(this.logoImageTransparent.getBoundingClientRect().width, "px"));
      } else if (this.logoImageMobile && this.logoImageMobile.offsetParent) {
        this.header.style.setProperty('--logo-width', "".concat(this.logoImageMobile.getBoundingClientRect().width, "px"));
      } else {
        this.header.style.setProperty('--logo-width', "".concat(this.headerLogo.getBoundingClientRect().width, "px"));
      }
    }
  }, {
    key: "_initTransparency",
    value: function _initTransparency() {
      var _this2 = this;

      document.body.removeAttribute('data-transparent-header'); // We only want to change transparency if the header is sticky
      // and if the first section is a banner.

      if (this.firstSectionIsBanner()) {
        if (this.sticky && this.transparent) {
          document.body.dataset.transparentHeader = true;
          this.scrollObserver = new IntersectionObserver(function (entries) {
            return _this2._setTransparency(entries);
          });
          this.scrollObserver.observe(this.scrollObserverPoint);
    ...
    value: function _setTransparency(entries) {
      if (!entries) {
        return;
      }

      if (entries[0].isIntersecting || !this.sticky) {
        document.body.dataset.transparentHeader = true;
      } else {
        document.body.dataset.transparentHeader = false;
      }
    ...
    value: function _updateCartCount(e) {
      var count = e.detail.count;
      this.cartCount.innerHTML = count;
    }
  }, {
    key: "firstSectionIsBanner",
    value: function firstSectionIsBanner() {
      var firstSection = document.querySelector('main section');
      return firstSection && firstSection.dataset.banner === 'true';
    }
  }, {
    key: "onSectionUnload",
    value: function onSectionUnload() {
      this.headerNav.unload();
      this.events.unregisterAll();
      ...
      document.body.removeAttribute('data-transparent-header');
    }
  }]);
...
/* harmony default export */ const pxs_header_standard_dist_index_es = (HeaderStandard);

;// CONCATENATED MODULE: ./node_modules/@pixelunion/pxs-drawer-nav-standard/dist/index.es.js
...
function pxs_drawer_nav_standard_dist_index_es_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

function pxs_drawer_nav_standard_dist_index_es_defineProperties(target, props) {
  for (var i = 0; i < props.length; i++) {
    var descriptor = props[i];
    descriptor.enumerable = descriptor.enumerable || false;
    descriptor.configurable = true;
...
function pxs_drawer_nav_standard_dist_index_es_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) pxs_drawer_nav_standard_dist_index_es_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) pxs_drawer_nav_standard_dist_index_es_defineProperties(Constructor, staticProps);
  return Constructor;
}

function pxs_drawer_nav_standard_dist_index_es_unwrapExports (x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}

function pxs_drawer_nav_standard_dist_index_es_createCommonjsModule(fn, module) {
	return module = { exports: {} }, fn(module, module.exports), module.exports;
}

var pxs_drawer_nav_standard_dist_index_es_EventHandler_1 = pxs_drawer_nav_standard_dist_index_es_createCommonjsModule(function (module, exports) {
exports.__esModule = true;
var EventHandler = /** @class */ (function () {
    function EventHandler() {
        this.events = [];
...
var pxs_drawer_nav_standard_dist_index_es_EventHandler = pxs_drawer_nav_standard_dist_index_es_unwrapExports(pxs_drawer_nav_standard_dist_index_es_EventHandler_1);

function dist_index_es_classCallCheck$1(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

function dist_index_es_defineProperties$1(target, props) {
  for (var i = 0; i < props.length; i++) {
    var descriptor = props[i];
    descriptor.enumerable = descriptor.enumerable || false;
    descriptor.configurable = true;
...
function dist_index_es_createClass$1(Constructor, protoProps, staticProps) {
  if (protoProps) dist_index_es_defineProperties$1(Constructor.prototype, protoProps);
  if (staticProps) dist_index_es_defineProperties$1(Constructor, staticProps);
  return Constructor;
}
...
var EventHandler_1$1 = createCommonjsModule$1(function (module, exports) {
...
var Events = /*@__PURE__*/getDefaultExportFromCjs(EventHandler_1$1);
...
var Disclosure = /*#__PURE__*/function () {
  function Disclosure(el) {
    dist_index_es_classCallCheck$1(this, Disclosure);
  ...
  dist_index_es_createClass$1(Disclosure, [{
    key: "_cacheSelectors",
 ...
 * @returns {Promise} Promise will resolve when requestAnimationFrame callback is run.
 */
function pxs_drawer_nav_standard_dist_index_es_raf() {
  return new Promise(function (resolve) {
    window.requestAnimationFrame(resolve);
  });
}
...
var pxs_drawer_nav_standard_dist_index_es_Animation =
/*#__PURE__*/
function () {
  /**
   * @param {Object} options
   ...
   */
  function Animation(options) {
    _classCallCheck$2(this, Animation);
  ...
  _createClass$2(Animation, [{
    ...
    value: function animateTo(state) {
      ...
      return new Promise(function (resolve) {
        ...
        pxs_drawer_nav_standard_dist_index_es_raf().then(function () {
          if (!running) throw new Error('cancelled');
          ...
          return pxs_drawer_nav_standard_dist_index_es_raf();
        }).then(function () {
          if (!running) throw new Error('cancelled');
...
function pxs_drawer_nav_standard_dist_index_es_transition(options) {
  return new pxs_drawer_nav_standard_dist_index_es_Animation(options);
}
 ...
 * @param {string} options.className - Class name to apply to element on focus.
 */
function index_es_forceFocus(element, options) {
  options = options || {};
...
function index_es_focusable(container) {
  var elements = Array.prototype.slice.call(
    container.querySelectorAll(
      '[tabindex],' +
        '[draggable],' +
...
var index_es_trapFocusHandlers = {};

function index_es_trapFocus(container, options) {
  options = options || {};
  var elements = index_es_focusable(container);
  var elementToFocus = options.elementToFocus || container;
  var first = elements[0];
  var last = elements[elements.length - 1];

  index_es_removeTrapFocus();

  index_es_trapFocusHandlers.focusin = function(event) {
    if (container !== event.target && !container.contains(event.target)) {
      first.focus();
    }
    ...
    if (
      ...
      return;
    document.addEventListener('keydown', index_es_trapFocusHandlers.keydown);
  };

  index_es_trapFocusHandlers.focusout = function() {
    document.removeEventListener('keydown', index_es_trapFocusHandlers.keydown);
  };

  index_es_trapFocusHandlers.keydown = function(event) {
    if (event.keyCode !== 9) return; // If not TAB key
  ...
  document.addEventListener('focusout', index_es_trapFocusHandlers.focusout);
  document.addEventListener('focusin', index_es_trapFocusHandlers.focusin);

  index_es_forceFocus(elementToFocus, options);
}

/**
 * Removes the trap of focus from the page
 */
function index_es_removeTrapFocus() {
  document.removeEventListener('focusin', index_es_trapFocusHandlers.focusin);
  document.removeEventListener('focusout', index_es_trapFocusHandlers.focusout);
  document.removeEventListener('keydown', index_es_trapFocusHandlers.keydown);
}

var DrawerNavSubmenu = /*#__PURE__*/function () {
  function DrawerNavSubmenu(settings) {
    var _this = this;

    pxs_drawer_nav_standard_dist_index_es_classCallCheck(this, DrawerNavSubmenu);

    this.menu = settings.submenu;
    this.trigger = settings.trigger;
    this.parentMenu = settings.parentMenu;
    this.tier = settings.tier;
    this.drawerMenu = settings.drawerMenu;
    this.submenu = null;
    this.backButton = this.menu.querySelector('[data-drawer-back-button]');
    this.closeButton = this.menu.querySelector('[data-drawer-close-button]');
    this.flyout = this.menu.querySelector('[data-drawer-submenu-flyout]');
    this.overlay = this.menu.querySelector('[data-drawer-submenu-overlay]');
    this.submenuTriggers = this.menu.querySelectorAll("[data-drawer-submenu-button=\"tier-".concat(this.tier, "\"]"));
    this.events = new pxs_drawer_nav_standard_dist_index_es_EventHandler();
    this.flyoutAnimation = pxs_drawer_nav_standard_dist_index_es_transition({
      el: this.flyout,
      state: 'closed'
    });
    this.overlayAnimation = pxs_drawer_nav_standard_dist_index_es_transition({
      el: this.overlay,
      state: 'closed'
    });
  ...
  pxs_drawer_nav_standard_dist_index_es_createClass(DrawerNavSubmenu, [{
    key: "open",
    value: function open() {
    ...
    value: function close() {
      ...
      index_es_removeTrapFocus(this.menu);
      this.trigger.focus();
      index_es_trapFocus(this.parentMenu);
    ...
    value: function openSubmenu(e) {
      ...
      this.submenu = new DrawerNavSubmenu({
        submenu: submenu,
        trigger: submenuTrigger,
        parentMenu: this.menu,
        tier: this.tier + 1,
        drawerMenu: this.drawerMenu
      });
    }
  }, {
    key: "unload",
  ...
  return DrawerNavSubmenu;
}();

var DrawerNavStandard = /*#__PURE__*/function () {
  function DrawerNavStandard(_ref) {
    var _this = this;

    var drawerTrigger = _ref.drawerTrigger;

    pxs_drawer_nav_standard_dist_index_es_classCallCheck(this, DrawerNavStandard);

    this.drawerTrigger = drawerTrigger;
    this.submenu = null;
    this.drawerNav = document.querySelector('[data-drawer-nav]');
    this.closeButton = this.drawerNav.querySelector('[data-drawer-nav-close]');
    this.mainFlyout = this.drawerNav.querySelector('[data-drawer-main-flyout]');
    this.overlay = this.drawerNav.querySelector('[data-drawer-overlay]');
    this.submenuTriggers = this.drawerNav.querySelectorAll('[data-drawer-submenu-button="tier-1"]');
    this.events = new pxs_drawer_nav_standard_dist_index_es_EventHandler();
    this.flyoutAnimation = pxs_drawer_nav_standard_dist_index_es_transition({
      el: this.mainFlyout,
      state: 'closed'
    ...
    this.events.register(this.drawerTrigger, 'click', function () {
      return _this.open();
    });
    this.events.register(this.closeButton, 'click', function () {
      return _this.close();
    ...
    this.countryDisclosureEl = this.drawerNav.querySelector('[data-disclosure-country]');
    this.localeDisclosureEl = this.drawerNav.querySelector('[data-disclosure-locale]');
    this.disclosures = [];
  ...
  pxs_drawer_nav_standard_dist_index_es_createClass(DrawerNavStandard, [{
    key: "open",
    value: function open() {
      var _this2 = this;

      this.drawerNav.dataset.open = true;
      this.flyoutAnimation.animateTo('open');
      this.overlayAnimation.animateTo('open');
      this.closeEvent = this.events.register(window, 'keydown', function (e) {
        return _this2.closeEsc(e);
      });
      this.drawerNav.focus();
      index_es_trapFocus(this.drawerNav);
    }
  }, {
    key: "close",
    value: function close() {
    ...
    value: function openSubmenu(e) {
      var submenuTrigger = e.target;
      var submenu = submenuTrigger.nextElementSibling;
      this.drawerNav.dataset.childOpen = true;
      this.submenu = new DrawerNavSubmenu({
        submenu: submenu,
        trigger: submenuTrigger,
        parentMenu: this.drawerNav,
        tier: 2,
        drawerMenu: this
      });
    }
  ...
  return DrawerNavStandard;
}();

/* harmony default export */ const pxs_drawer_nav_standard_dist_index_es = (DrawerNavStandard);

;// CONCATENATED MODULE: ./source/scripts/components/DrawerNav.js


class DrawerNav extends pxs_drawer_nav_standard_dist_index_es {
  constructor(settings) {
    super(settings);
    this.menuLinks = this.drawerNav.querySelectorAll('[data-drawer-link-tier-1]');
  }

  open() {
    ScrollLock.lock(this.drawerNav);
    super.open();
    this.menuLinks.forEach((menuLink, i) => {
      // Delay is staggered for each menu item
      const delay = 600 + i * 100;
      setTimeout(() => menuLink.classList.add('drawer-menu__tier-1-link--open'), delay);
    });
  }
  ...
  close() {
    ...
    this.menuLinks.forEach(menuLink => {
      menuLink.classList.remove('drawer-menu__tier-1-link--open');
    });
  }
...
class StaticHeader extends pxs_header_standard_dist_index_es {
  constructor(section) {
    super(section); // In Startup, only the last (right) header controls are available in the header
    // on desktop. The animation is currently only intended to work on desktop

    this.searchButton = this.el.querySelectorAll('[data-search-button]')[1];
    this.headerControls = this.el.querySelectorAll('[data-header-controls]')[1];
    this.headerAccountButton = this.headerControls.querySelector('[data-account-button]');
    this.headerCartButton = this.headerControls.querySelector('[data-cart-button]');
    this.searchContainer = this.el.querySelector('[data-header-search]');
    this.searchForm = this.el.querySelector('[data-header-search-form]');
    this.searchInput = this.el.querySelector('[data-header-search-input]');
    this.searchCloseButton = this.el.querySelector('[data-search-close]');
    this.searchSubmitButton = this.el.querySelector('[data-search-submit]');
    this.headerNavEl = this.el.querySelector('[data-header-nav]');
    this.closedState = 'closed';
    this.openState = 'open';
    this.searchIsOpen = false;
    this.navShouldAnimate = typeof this.headerNavEl !== 'undefined' && this.headerNavEl !== null && this.searchForm.dataset.headerNavPosition !== 'below';
    this.drawerTrigger = this.el.querySelector('[data-menu-button]');
    this.drawerNav = new DrawerNav({
      drawerTrigger: this.drawerTrigger
    });

    if (this.searchButton) {
      this.events.register(this.searchCloseButton, 'click', event => this._closeSearchForm(event));
      this.events.register(this.searchButton, 'click', event => this._handleSearchButtonClick(event));

      this._initAnimations();

      this._insertSearchForm();
    }
  }

  _initAnimations() {
    // Responsible for animating the search icon's underline
    // that expands across the search form
    this.searchButtonAnimation = transition({
      el: this.searchButton,
      state: this.closedState
    }); // Responsible for animating the appearance of the
    // input's placeholder text

    this.searchInputAnimation = transition({
      el: this.searchInput,
      state: this.closedState
    }); // Responsible for the fade in/out of the close button
    // on the search form

    this.searchCloseButtonAnimation = transition({
      el: this.searchCloseButton,
      state: this.closedState
    }); // Responsible for the fade in/out of the header icons

    this.searchContainerAnimation = transition({
      el: this.searchContainer,
      state: this.closedState
    });

    if (this.navShouldAnimate) {
      // Responsible for the fade in/out of the navigation
      this.headerNavAnimation = transition({
        el: this.headerNavEl,
        state: this.openState
      });
    } // Responsible for fade in/out on header control icons
    // (Account, if they're enabled, and cart)


    if (this.headerAccountButton) {
      this.headerAccountButtonAnimation = transition({
        el: this.headerAccountButton,
        state: this.openState
      });
    }

    if (this.headerCartButton) {
      this.headerCartButtonAnimation = transition({
        el: this.headerCartButton,
        state: this.openState
      });
    }
  }
  ...
  _handleSearchButtonClick(event) {
    ...
    if (this.searchIsOpen) {
      ...
      let controlsWidth = 0;
      controlsWidth = this.headerCartButton ? controlsWidth + this.headerCartButton.getBoundingClientRect().width : controlsWidth;
      controlsWidth = this.headerAccountButton ? controlsWidth + this.headerAccountButton.getBoundingClientRect().width : controlsWidth;
      controlsWidth = this.searchButton ? controlsWidth + this.searchButton.getBoundingClientRect().width : controlsWidth;
      this.headerControls.style.setProperty('--header-controls-width', `${controlsWidth}px`);
  ...
  _insertSearchForm() {
    // We need to insert the search form directly after the search button
    // so that users using keyboard navigation can access the submit button
    this.searchButton.parentNode.insertBefore(this.searchContainer, this.searchButton.nextSibling);
  }

  _openSearch() {
    this._runSearchAnimations(this.openState);

    this._runHeaderAnimations(this.closedState).then(() => this.searchContainerAnimation.animateTo(this.openState)).then(() => {
      this.searchInput.focus();
      this.closeSearchEscEvent = this.events.register(window, 'keydown', event => this._closeSearchFormEsc(event));
      this.searchIsOpen = true;
    });
  }

  _closeSearch() {
    this._runSearchAnimations(this.closedState).then(() => {
      this._runHeaderAnimations(this.openState);

      this.searchContainerAnimation.animateTo(this.closedState);
      this.events.unregister(this.closeSearchEscEvent);
      this.searchIsOpen = false;
      this.searchInput.value = '';
    });
  }

  _runHeaderAnimations(state) {
    return new Promise((resolve, reject) => {
      if (this.headerAccountButton) {
        this.headerAccountButtonAnimation.animateTo(state);
      }

      if (this.headerCartButton) {
        this.headerCartButtonAnimation.animateTo(state);
      }

      if (this.navShouldAnimate) {
        this.headerNavAnimation.animateTo(state).then(() => resolve()).catch(() => reject());
      } else {
        resolve();
      }
    });
  ...
  _runSearchAnimations(state) {
    return new Promise((resolve, reject) => {
      this.searchCloseButtonAnimation.animateTo(state);
      this.searchInputAnimation.animateTo(state);
      this.searchButtonAnimation.animateTo(state).then(() => resolve()).catch(() => reject());
    });
  }

  _closeSearchForm(event) {
    event.preventDefault();

    this._closeSearch();
  }

  _closeSearchFormEsc(event) {
    if (event.key === 'Escape') {
      this._closeSearchForm(event);
...
class FacetedFiltering {
  ...
  _setDropdownHeight() {
    const filterWrapper = this.el.querySelector('[data-faceted-filter]');
    let maxHeight = 0;
    ...
    filterWrapper.style.setProperty('--closed-filter-height', `${maxHeight}px`);
  }
  ...
  _initFilterEvents() {
    ...
    this.filterInputs.forEach(filter => {
      this.events.register(filter, 'click', e => {
        ...
        if (this.fillAnimations[handle] && this.checkAnimations[handle]) {
          ...
          this.checkAnimations[handle].animateTo(animateTo).then(() => {
            window.location = url;
          });
        }
      });
    ...
    this.filterRange.forEach(filter => {
      ...
      this.events.register(filter, 'keyup', e => {
        // Don't update if the user is tabbing through the elements
        if (e.key !== 'Tab') {
  ...
  _initAnimations() {
    this.filterCheckboxes.forEach(el => {
      ...
      if (el.closest('[data-filter-input]').hasAttribute('data-filter-active')) {
        state = 'checked';
      }

      const fillAnimation = transition({
        el: checkmark,
        state
      });
      const checkAnimation = transition({
        el: checkmarkCheck,
        state
      });
  ...
  _setStyleVariables(el) {
    ...
    const mobileWidth = main.getBoundingClientRect().width - 30;
...
class StaticCollection {
  constructor(section) {
    this.el = section.el;
    this.events = new dist_EventHandler/* default */.Z();
    this.facetedFilters = new FacetedFiltering(section);
    this.sortSelect = this.el.querySelector('[data-collection-sort]');

    if (this.sortSelect) {
      this.events.register(this.sortSelect, 'change', () => this._updateSort());
    }
  }
  ...
  _updateSort() {
    let search;
    const Sorting = {};
    Sorting.sort_by = this.sortSelect.value;
    const currentVendorSelected = this.sortSelect.classList.contains('vendor-collection');

    if (currentVendorSelected || this.facetedFilters !== null) {
      ...
      window.location.search = `${search}&${Object.keys(Sorting).map(k => `${encodeURIComponent(k)}=${encodeURIComponent(Sorting[k])}`).join('&')}`;
    } else {
      window.location.search = Object.keys(Sorting).map(k => `${encodeURIComponent(k)}=${encodeURIComponent(Sorting[k])}`).join('&');
    }
  }
...
function index_es_getDefaultExportFromCjs (x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}

function shopify_cross_border_dist_index_es_createCommonjsModule(fn) {
  var module = { exports: {} };
	return fn(module, module.exports), module.exports;
}

var shopify_cross_border_dist_index_es_EventHandler_1 = shopify_cross_border_dist_index_es_createCommonjsModule(function (module, exports) {
...
var index_es_Events = /*@__PURE__*/index_es_getDefaultExportFromCjs(shopify_cross_border_dist_index_es_EventHandler_1);

var index_es_selectors = {
  disclosureList: '[data-disclosure-list]',
  disclosureToggle: '[data-disclosure-toggle]',
  disclosureInput: '[data-disclosure-input]',
  disclosureOptions: '[data-disclosure-option]'
};
var index_es_classes = {
  listVisible: 'disclosure-list--visible',
  alternateDrop: 'disclosure-list--alternate-drop'
};

var index_es_Disclosure = /*#__PURE__*/function () {
  function Disclosure(el) {
    shopify_cross_border_dist_index_es_classCallCheck(this, Disclosure);

    this.el = el;
    this.events = new index_es_Events();
    this.cache = {};
  ...
  shopify_cross_border_dist_index_es_createClass(Disclosure, [{
    ...
    value: function _cacheSelectors() {
      this.cache = {
        disclosureList: this.el.querySelector(index_es_selectors.disclosureList),
        disclosureToggle: this.el.querySelector(index_es_selectors.disclosureToggle),
        disclosureInput: this.el.querySelector(index_es_selectors.disclosureInput),
        disclosureOptions: this.el.querySelectorAll(index_es_selectors.disclosureOptions)
      };
    }
  }, {
    key: "_connectToggle",
    value: function _connectToggle() {
      ...
      this.events.register(this.cache.disclosureToggle, 'click', function (e) {
        ...
        _this.cache.disclosureList.classList.remove(index_es_classes.alternateDrop);

        _this.cache.disclosureList.classList.toggle(index_es_classes.listVisible);
        ...
        window.requestAnimationFrame(function () {
          ...
          if (left + width + gutter > innerWidth) {
            _this.cache.disclosureList.classList.add(index_es_classes.alternateDrop);
          }
        });
      });
    }
    ...
    value: function _onFocusOut() {
      ...
      this.events.register(this.cache.disclosureList, 'focusout', function (e) {
        ...
        var isVisible = _this3.cache.disclosureList.classList.contains(index_es_classes.listVisible);
    ...
    key: "_hideList",
    value: function _hideList() {
      this.cache.disclosureList.classList.remove(index_es_classes.listVisible);
      this.cache.disclosureToggle.setAttribute('aria-expanded', false);
    }
  }, {
    key: "unload",
...
/* harmony default export */ const shopify_cross_border_dist_index_es = (index_es_Disclosure);
...
class CartRequests {
  constructor() {
    ...
    this.processing = false;
    this.interval = setInterval(() => this._postRequests(), this.processRequestInterval);
    this.requests = [];
  }

  addItem(data) {
    const request = this._findAddItemRequest(data);
  ...
  changeItem(data) {
    const request = this._findChangeItemRequest(data);
  ...
  updateNote(note) {
    this.requests = this.requests.filter(r => r.type !== 'update');
    this.requests.push({
      type: 'update',
      data: {
        note
  ...
  _triggerFinishLoadingEvent(newCart, oldCart, error) {
    const newItems = newCart.items.filter(newItem => {
  ...
  _postRequests() {
    ...
    let $deferred = jquery_default().Deferred().resolve();
    $deferred = $deferred.then(() => jquery_default().get({
    ...
    requestsToProcess.forEach(request => {
      ...
      if (request.type === 'add') {
        deferredRequest = () => jquery_default().post({
      ...
      if (request.type === 'update') {
        deferredRequest = () => jquery_default().post({
          url: `${window.Theme.routes.cart_url}/update.js`,
          data: request.data,
          dataType: 'json'
        });
      }
    ...
    $deferred = $deferred.then(() => jquery_default().get({
      url: `${window.Theme.routes.cart_url}.js`,
      dataType: 'json'
    })).then(newCart => this._triggerFinishLoadingEvent(newCart, originalCart)).catch(error => {
      this._handleError(error.responseJSON.description);

      jquery_default().get({
        url: `${window.Theme.routes.cart_url}.js`,
        dataType: 'json'
      }).then(newCart => this._triggerFinishLoadingEvent(newCart, originalCart, error));
    }).always(() => {
      this.processing = false;
    });
  }

  _findAddItemRequest(data) {
    let request = null;
...
/* harmony default export */ const utils_CartRequests = (new CartRequests());
...
class LineItem {
  constructor(el) {
    ...
    this.remove = e => {
      ...
      this._changeQuantity(0);
    };

    this.decrementQuantity = e => {
      e.preventDefault();

      this._changeQuantity(parseInt(this.quantityInputEl.value, 10) - 1);
    };
  ...
  _onQuantityChange() {
    const quantity = Math.max(0, this.quantityInputEl.value);
...
class ShippingCalculator {
  constructor(el) {
    ...
    jquery_default()('[data-calculate-shipping-button]', this.el).on('click', () => this.calculateShipping());
  ...
  shippingCalculator() {
    ...
    const selectableOptions = jquery_default()('.cart-shipping-calculator select', this.el);
    setTimeout(() => {
      for (let i = 0; i < selectableOptions.length; i++) {
        this.updateShippingLabel(selectableOptions[i]);
      }
    }, 500);
    jquery_default()('.cart-shipping-calculator select', this.el).change(() => {
      for (let i = 0; i < selectableOptions.length; i++) {
        this.updateShippingLabel(selectableOptions[i]);
      }
    });
  ...
  calculateShipping() {
    ...
    jquery_default().ajax(`${window.Theme.routes.cart_url}/shipping_rates.json?${queryString}`, {
      dataType: 'json'
    }).fail(error => this.handleErrors(error.responseJSON || {})).done(response => {
      ...
      if (rates.length > 1) {
        ...
        responseText = this.data.language.multi_rates.replace('** address **', address).replace('** number_of_rates **', rates.length).replace('** rate **', `<span class='money'>${firstRate}</span>`);
        ratesFeedback.html(responseText);
      } else if (rates.length === 1) {
        responseText = this.data.language.one_rate.replace('** address **', address);
        ratesFeedback.html(responseText);
      } else {
        ratesFeedback.html(this.data.language.no_rates);
      }

      for (let i = 0; i < rates.length; i++) {
        const rate = rates[i];
        const price = Shopify.Cart.ShippingCalculator.formatRate(rate.price);
        const rateValues = this.data.language.rate_values.replace('** rate_title **', rate.name).replace('** rate **', `<span class='money'>${price}</span>`);
        jquery_default()('.shipping-rates', this.el).append(`<li>${rateValues}</li>`);
      }

      jquery_default()('[data-calculate-shipping-button]').val(this.data.language.submit_button);
    });
  }
    ...
    if (select) {
      ...
      setTimeout(() => {
        if ($select.attr('name') === 'address[country]') {
          this.updateShippingLabel(jquery_default()('#address_province', this.el));
        }
      }, 500);
    }
  }
  ...
  handleErrors(errorMessage) {
    if (errorMessage.zip) {
      ...
      errorMessage = this.data.language.generic_error_message.replace('** error_message **', errorMessage.error.map(error => Object.keys(error).map(key => error[key]).join('\n')).join('\n'));
    } else {
      return;
    }

    jquery_default()('.cart-shipping-calculator-response').html(`<p>${errorMessage}</p>`);
  }
  ...
  unload() {
    jquery_default()('[data-calculate-shipping-button]', this.el).off('click', () => this.calculateShipping());
...
class StaticCart {
  constructor(section) {
    ...
    const itemEls = section.el.querySelectorAll('[data-line-item]');
    this.items = [];

    for (let i = 0; i < itemEls.length; i++) {
      this.items.push(new LineItem(itemEls[i]));
    }

    const shippingCalculatorEl = section.el.querySelector('[data-shipping-calculator]');

    if (shippingCalculatorEl) {
      this.shippingCalculator = new ShippingCalculator(shippingCalculatorEl);
    }
  ...
  _onUpdateFinish() {
    shopify_asyncview_dist_index_es.load(window.Theme.routes.cart_url, {
      ...
      if (data.item_count === 0) {
        ...
        const form = this.section.el.querySelector('[data-cart]');
        const shipping = this.section.el.querySelector('[data-shipping-calculator]');
      ...
      const itemsEl = this.section.el.querySelector('[data-cart-items]');
      const noteEl = this.section.el.querySelector('[data-cart-note]');
      const totalsEl = this.section.el.querySelector('[data-cart-totals]');
      const newItemsEl = document.createElement('div');
      const newNoteEl = document.createElement('div');
      const newTotalsEl = document.createElement('div'); // This should be removed and the update should occur locally to the element
      ...
      this.items = [];
      const itemEls = this.section.el.querySelectorAll('[data-line-item]');

      for (let i = 0; i < itemEls.length; i++) {
        this.items.push(new LineItem(itemEls[i]));
      }

      this.section.el.classList.remove('cart-updating');
      this.cartNoteEl = this.section.el.querySelector('[data-cart-note]');
...
class StaticArticleList {
  ...
  wrapAllNodes() {
    const childNodes = jquery_default()('.rte', this.$el);

    for (let i = 0; i < childNodes.length; i++) {
      const node = childNodes[i];

      if (node.nodeType === 3 && node.textContent.replace(/^\s+|\s+$/g, '')) {
        jquery_default()(node).replaceWith(`<p>${node.textContent}</p>`);
      }
    }
  }

  setFeaturedImage(load) {
    const featuredImage = jquery_default()('.featured-image', this.$el);

    if (featuredImage.length) {
      if (featuredImage.hasClass('full-bleed-featured-image')) {
        const windowWidth = jquery_default()(window).width();
        const contentWidth = this.$el.outerWidth(true);
        featuredImage.css({
          width: windowWidth,
  ...
  artDirection() {
    const images = jquery_default()('.post-content img', this.$el);
    images.one('rimg:load', () => {
      for (let i = 0; i < images.length; i++) {
        const image = jquery_default()(images[i]);
        ...
        if (!image.hasClass('post-image')) {
          ...
          if (image.css('float') !== 'none') {
            const direction = image.css('float');
          ...
          if (imageAlt && imageAlt.length && imageParent.not('img')) {
            const marginLeft = image.css('margin-left');
            const marginRight = image.css('margin-right');
            imageParent.append(`
              <div
                style="
...
class StaticBlog {
  ...
  render() {
    const $articleListItem = jquery_default()('[data-blog-list-item]', this.$el);

    if ($articleListItem.length === 0) {
      return;
    }

    $articleListItem.map((i, listItem) => this.listViews.push(new StaticArticleList({
      el: listItem
    })));
  }
  ...
  onSectionUnload() {
    this.listViews.map(listView => listView.unload());
  }
...
/* harmony default export */ const ProductReviews = ({
...
class StaticProductRecommendations {
  ...
  _loadRecommendations() {
    shopify_asyncview_dist_index_es.load(this.recommendUrl, this.queryParams).then((_ref) => {
      let {
        data,
        html
      } = _ref;
...
class StaticAddresses {
  ...
  _bindEvents() {
    jquery_default()('.delete-address', this.$el).on('click', e => this.deleteAddress(e));
    jquery_default()('.edit-address', this.$el).on('click', e => this.editAddress(e));
    jquery_default()('.cancel-edit', this.$el).on('click', e => this.cancelEditing(e));
    jquery_default()('.toggle-new-address', this.$el).on('click', () => this.toggleNewAddress());
    jquery_default()('.select-wrapper select', this.$el).on('change', e => this.updateSelectedText(e, false));
  }
  ...
  prepareAddresses() {
    ...
    const addresses = jquery_default()('.customer-address', this.$el);
    ...
    const selectableOptions = jquery_default()('.select-wrapper select', this.$el);

    for (let i = 0; i < selectableOptions.length; i++) {
      this.updateSelectedText(null, selectableOptions[i]);
    }
  }

  updateSelectedText(e, select) {
    const text = e ? jquery_default()(e.target) : jquery_default()(select);
    const selectedValue = text.find('option:selected').text();
    ...
    if (text.attr('name') === 'address[country]') {
      let addressID = jquery_default()(text).attr('id').split('address-country-')[1];
  ...
  editAddress(e) {
    const addressID = jquery_default()(e.target).parents('[data-address-id]').data('address-id');
    jquery_default()(`.customer-address[data-address-id='${addressID}']`).addClass('editing');
    jquery_default()(`.customer-address-edit-form[data-address-id='${addressID}']`).addClass('show');
    this.prepareAddresses();
  }
...
class Account {
  constructor(section) {
    this.$el = jquery_default()(section.el);
    jquery_default()('.toggle-forgetfulness span', this.$el).on('click', () => this.recoverPassword());

    if (jquery_default()(document.body).hasClass('template-customers-addresses')) {
      this.StaticAddresses = new StaticAddresses({
...
class Contact {
  constructor(section) {
    this.$el = jquery_default()(section.el);
    jquery_default()('.contact-form', this.$el).on('submit', () => this.spamCheck());
  }
...
class GiftCard {
  ...
  addQrCode() {
    const qrWrapper = this.el.querySelector(this.qrCode);
...
class ImagesWithText {
  constructor(section) {
    this.$el = jquery_default()(section.el);
    this.$window = jquery_default()(window);
    this.centerText(this.$el);
    this.$window.on('resize.images-with-text', ThemeUtils.debounce(() => this.centerText(this.$el), 10));
  }
  ...
  centerText($container) {
    ...
    const $content = $container.find('[data-feature-content]');
...
class RTE {
  ...
  _bindEvents() {
    jquery_default()('.tabs li', this.$el).on('click', event => this.switchTabs(event));
    jquery_default()('.select-wrapper select', this.$el).on('change', event => this.updateOption(event));
  }

  switchTabs(event) {
    event.preventDefault();
    const tab = jquery_default()(event.currentTarget);
  ...
  updateOption(event, selector) {
    const select = event ? jquery_default()(event.target) : jquery_default()(selector);
...
class Startup {
  constructor() {
    const body = jquery_default()(document.body); // Set up conditionals
    ...
    this.isSearch = jquery_default()('[data-section-type="static-search"]').length;
    FlickityTouchFix(); // Common views

    this.sections = new shopify_sections_manager_es();
    this.sections.register('pxs-header-standard', section => new StaticHeader(section));
    this.sections.register('static-footer', section => new StaticFooter(section));
    this.sections.register('pxs-map', section => new PxsMap(section));
    this.sections.register('pxs-video', section => new pxs_video_dist_index_es(section));
    this.sections.register('pxs-faq', section => new DynamicFAQ(section));
    dist_index_es.init(); // Conditional views

    this.sections.register('dynamic-featured-product', section => new Product(section));
    this.sections.register('dynamic-twitter', section => new DynamicTwitter(section));
    this.sections.register('dynamic-image-with-text', section => new ImagesWithText(section));
    this.sections.register('dynamic-image-with-text-overlay', section => new ImagesWithText(section));
    this.sections.register('pxs-slideshow', section => new pxs_slideshow_dist_index_es(section));
    this.sections.register('pxs-testimonials', section => new pxs_testimonials_dist_index_es(section));

    if (this.isCollection) {
      this.sections.register('static-collection', section => new StaticCollection(section));
    }

    if (this.isGiftCardPage) {
      this.sections.register('static-giftcard', section => new GiftCard(section));
    }

    if (this.isContactPage) {
      this.sections.register('static-contact', section => new Contact(section));
    }

    if (this.isProduct) {
      this.sections.register('static-product', section => new Product(section));
      this.sections.register('static-product-recommendations', section => new StaticProductRecommendations(section));
    }

    if (this.isCart) {
      this.sections.register('static-cart', section => new StaticCart(section));
    }

    if (this.isBlog) {
      this.sections.register('static-blog', section => new StaticBlog(section));
    }

    if (this.isBlogPost) {
      this.sections.register('static-article', section => new StaticBlog(section));
    }

    if (this.isSearch) {
      this.sections.register('static-search', section => new StaticSearch(section));
    }
    ...
    this.rtes = [];
    this.richTextInit();
    ThemeUtils.externalLinks(jquery_default()(document));
    jquery_default()(document).on('shopify:section:load', event => {
      ThemeUtils.externalLinks(jquery_default()(event.target));
      this.richTextInit();
      initShopifyProductReviews();
    });
    this.classHoist();
    jquery_default()(document).on('shopify:section:select.home-page', () => this.classHoist()).on('shopify:section:load.home-page', () => this.classHoist()).on('shopify:section:deselect.home-page', () => this.classHoist());
  }

  getStyle($el) {
    const styleSetting = $el.attr('class').match(/(default|contrast|accent)-style/);
  ...
  getSectionWidth($el) {
    const sectionWidthSetting = $el.attr('class').match(/content-width|full-width/);

    if (sectionWidthSetting !== null) {
      return sectionWidthSetting[0];
    }
  ...
  classHoist() {
    jquery_default()('.module-container').each((index, section) => {
      const $section = jquery_default()(section);
      const $parent = $section.parent();
      const sectionStyle = this.getStyle($section);
      const parentStyle = this.getStyle($parent);
      const sectionWidthStyle = this.getSectionWidth($section);

      if (sectionWidthStyle) {
        $parent.addClass(sectionWidthStyle);
      }
  ...
  richTextInit() {
    for (let i = 0; i < jquery_default()('.rte').length; i++) {
      this.rtes.push(new RTE({
...
jquery_default()(() => {
  window.theme = new Startup();
});
})();

/******/ })()
;
//# sourceMappingURL=startup.js.map?1658331185227